...
export const GYM_LEADERS: GymLeader[] = [
  {
    ...
    bias: ['rock', 'ground'], teamSize: 1, levelDelta: 1, coinMultiplier: 1.8,
  ...
  },
  {
    ...
    bias: ['water'], teamSize: 2, levelDelta: 2, coinMultiplier: 1.9,
  ...
  },
  {
    ...
    bias: ['electric'], teamSize: 2, levelDelta: 2, coinMultiplier: 2.0,
  ...
  },
  {
    ...
    bias: ['grass', 'poison'], teamSize: 3, levelDelta: 4, coinMultiplier: 2.0,
  ...
  },
  {
    ...
    bias: ['poison', 'bug'], teamSize: 3, levelDelta: 4, coinMultiplier: 2.1,
  ...
  },
  {
    ...
    bias: ['psychic'], teamSize: 3, levelDelta: 5, coinMultiplier: 2.2,
  ...
  },
  {
    ...
    bias: ['fire'], teamSize: 3, levelDelta: 6, coinMultiplier: 2.3,
  ...
  },
  {
    ...
    bias: ['ground', 'rock'], teamSize: 4, levelDelta: 7, coinMultiplier: 2.6,
